...
namespace SoftUniRestaurant.Models.Drinks.DrinkModels
{
    public abstract class Drink : IDrink
    {
        ...
        protected Drink(string name, int servingSize, decimal price, string brand) : this(name, servingSize, brand)
        {
            this.Price = price;
        }

        protected Drink(string name, int servingSize, string brand)
        {
            this.Name = name;
